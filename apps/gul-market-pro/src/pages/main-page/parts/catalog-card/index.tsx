      ...
      <div className="flex flex-col pt-5 pl-5 pb-5">
        ...
        <div className="flex flex-col gap-1 mb-3">
          {examples.map((example, index) => (
            <Typography children={example} key={index} className="font-normal text-sm text-label whitespace-nowrap" />
          ))}
        </div>
        <button className="rounded-full py-0.5 px-3 bg-gr-800 font-normal text-sm text-primary w-[98px] h-[24px]">
          К каталогу
        </button>
      </div>
